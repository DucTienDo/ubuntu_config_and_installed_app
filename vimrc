...
colorscheme sonokai
set cursorline
hi CursorLine term=bold cterm=bold guibg=#777777
...
let g:NERDTreeMapOpenInTabSilent = '<Enter>'
...
inoremap <expr> <Leader><Tab> pumvisible() ? "\<C-n>" : "\<Tab>"
